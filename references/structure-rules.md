# Skill & Agent Structure Rules

Based on Anthropic's Guide for writing Claude Code skills and agents.
...
- `description`: when to trigger (trigger phrases, not boilerplate examples)
